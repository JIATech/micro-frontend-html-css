        ...
        function c(b, c) {
            function C(b) {
                if (
                    !(
                        ja() ||
                        a(b.target).closest(c.excludedElements, Sa).length > 0
                    )
                ) {
                    var d,
                ...
                if (k == l) {
                    ...
                    if (j == w && T()) {
                        if (
                            ...
                            c.swipe &&
                                ((q = c.swipe.call(Sa, b, Ka, Ja, La, Ua, Va)),
                                q === !1))
                        )
                            return !1;
                        switch (Ka) {
                ...
                return (
                    k == n
                        ...
                        ? (j !== x && j !== w) ||
                          ...
                          c.doubleTap &&
                              (q = c.doubleTap.call(Sa, b, b.target)))
                        : k == p &&
                          ((j !== x && j !== w) ||
                              (clearTimeout(_a),
                              ($a = null),
                              ...
                              c.longTap &&
                                  (q = c.longTap.call(Sa, b, b.target)))),
                    q
                );
            }
            function L() {
            ...
            try {
                ...
                a.error(
                    "events not supported " + Ea + "," + Ia + " on jQuery.swipe"
                );
            }
    ...
    (function (a, b, c, d) {
        ...
        (f.prototype.init = function () {
            ...
            "" !== this.options.urlCurl &&
                ((i.googlePlus =
                    this.options.urlCurl + "?url={url}&type=googlePlus"),
                (i.stumbleupon =
    ...
    +(function () {
        ...
        (b.prototype.listen = function () {
            document.body.addEventListener(
                "click",
                function (a) {
                    "zoom" === a.target.getAttribute("data-action") &&
                        this._zoom(a);
                }.bind(this)
            );
        }),
            ...
            (b.prototype._touchMove = function (a) {
                Math.abs(a.touches[0].pageY - this._initialTouchPosition) >
                    10 &&
                    (this._activeZoomClose(),
            ...
            (c.prototype.zoomImage = function () {
                ...
                (a.onload = function () {
                    ...
                    (a.src =
                        this._targetImage.currentSrc || this._targetImage.src);
            }),
            (c.prototype._zoomOriginal = function () {
                (this._targetImageWrap = document.createElement("div")),
                    (this._targetImageWrap.className = "zoom-img-wrap"),
                    (this._targetImageWrap.style.position = "absolute"),
                    (this._targetImageWrap.style.top =
                        a(this._targetImage).top + "px"),
                    (this._targetImageWrap.style.left =
                        a(this._targetImage).left + "px"),
                ...
                return (
                    ...
                    !1 in document.body.style
                        ...
                        : ((i = this.dispose.bind(this)),
                          this._targetImage.addEventListener(
                              "transitionend",
                              i
                          ),
                          void this._targetImage.addEventListener(
                              "webkitTransitionEnd",
                              i
                          ))
                );
            ...
            (c.prototype.dispose = function () {
                this._targetImageWrap &&
                    ...
                    this._targetImageWrap.parentNode.removeChild(
                        this._targetImageWrap
                    ),
                    this._overlay.parentNode.removeChild(this._overlay),
                    this._body.classList.remove("zoom-overlay-transitioning")),
                    this._targetImage.removeEventListener("transitionend", i),
                    this._targetImage.removeEventListener(
                        "webkitTransitionEnd",
                        i
                    );
            }),
            $(function () {
                (window.isMobile && !window.enableMobileZoom) ||
                    new b().listen();
            });
    })();
var _gsScope =
                ...
                (C._updateRoot = F.render =
                    function () {
                        ...
                        if (
                            (I.length && T(),
                            R.render(
                                (g.time - R._startTime) * R._timeScale,
                                !1,
                                !1
                            ),
                            Q.render(
                                (g.frame - Q._startTime) * Q._timeScale,
                                !1,
                                !1
                            ),
                            I.length && T(),
        ...
        d.extend(n, b.prototype),
            ...
            (n.dispatchEvent = function (a, b, c) {
                ...
                if ((this.emitEvent(a, d), j))
                    if (
                        ((this.$element = this.$element || j(this.element)), b)
                    ) {
                        var e = j.Event(b);
    ...
    (function (a, b) {
        ...
        (e.prototype = Object.create(b.prototype)),
            ...
            (e.prototype.addElementImages = function (a) {
                ...
                if (b && k[b]) {
                    for (
                        var c = a.querySelectorAll("img"), d = 0;
                        d < c.length;
                        d++
                    ) {
                        var e = c[d];
    ...
    !(function (a) {
        ...
        function b(b) {
            ...
            b.isDefaultPrevented() ||
                (b.preventDefault(), a(b.target).ajaxSubmit(c));
        }
        function c(b) {
            var c = b.target,
                d = a(c);
            ...
            (a.fn.ajaxSubmit = function (b) {
                ...
                function h(c) {
                        ...
                        if (!s.aborted && !F) {
                            ...
                            if ((E && E.location.href != m.iframeSrc) || v) {
                                ...
                                try {
                                    ...
                                    (s.responseText = i ? i.innerHTML : null),
                                        ...
                                        i &&
                                            ((s.status =
                                                Number(
                                                    i.getAttribute("status")
                                                ) || s.status),
                                            (s.statusText =
                                                i.getAttribute("statusText") ||
                                                s.statusText));
                                ...
                                s.aborted && (d("upload aborted"), (f = null)),
                                    ...
                                    n &&
                                        a.event.trigger("ajaxComplete", [s, m]),
                                    n &&
                                        !--a.active &&
                                        a.event.trigger("ajaxStop"),
                                    m.complete &&
                                        m.complete.call(m.context, s, f),
                                    (F = !0),
                    ...
                    if (
                        ...
                        (s = {
                            ...
                            abort: function (b) {
                                ...
                                q.attr("src", m.iframeSrc),
                                    ...
                                    n &&
                                        a.event.trigger("ajaxError", [s, m, c]),
                                    m.complete &&
                                        m.complete.call(m.context, s, c);
                            },
                        }),
                        (n = m.global),
                        ...
                        m.beforeSend &&
                            m.beforeSend.call(m.context, s, m) === !1)
                    )
                ...
                if (
                    (b.data &&
                        ((b.extraData = b.data), (o = a.param(b.data, n))),
                ...
                if (
                    (this.trigger("form-submit-validate", [q, this, b, m]),
                    m.veto)
                )
                    return (
                        d(
                ...
                if (
                    ((b.success = function (a, c, d) {
                        for (
                            var e = b.context || this, f = 0, g = s.length;
                            g > f;
                            f++
                        )
                ...
                window.matchMedia
                    ...
                    : ((i = document.getElementsByTagName("head")[0]),
                      ...
                      (h = function (a) {
                          ...
                          var b =
                              "underline" ==
                              getComputedStyle(k, null).textDecoration;
    ...
    $(document).ready(function () {
                ...
                m(),
                    ...
                    window.loaded &&
                        ...
                        (window.clearElementAnimation = setTimeout(function () {
                            $(".slide.selected [class*='ae-']").addClass(
                                "done"
                            );
                        }, window.slideSpeed +
                            window.effectSpeed +
            ...
            p++,
                ...
                $(".slide").each(function (a, b) {
                    var c = $(b),
                        ...
                        g = c.height(),
                        i =
                            window.windowHeight / 2 > g
                                ? g / 2
                                : window.windowHeight / 2,
                        j = f < window.windowHeight + e - i && f > e - g + i,
                        k =
                            2 *
                            ((e + window.windowHeight - f) /
                                (window.windowHeight + g) -
                                0.5),
                        l = !0;
                    0 === e && (l = 0 === a),
                        ...
                        !(k > -1 && k < 1) ||
                            ...
                            ((c.hasClass("parallax") ||
                                c.find(".parallax-element")) &&
                                c.find(".parallax-element").each(function () {
                                    var a = $(this),
                                        b = parseInt(
                                            a.data("parallax-velocity")
                                        )
                                            ? parseInt(
                                                  a.data("parallax-velocity")
                                              )
        ...
        function g(a) {
            var b = $(window).scrollTop(),
                ...
                f = c.offset().top,
                g = f + d;
            return d >= window.windowHeight / 5
                ? e >= f + d / 5
                : b < f && e > g;
        }
        function h() {
        ...
        function i() {
            if (window.sidebarShown) {
                $html
                    .removeClass("sidebarShown")
                    .removeClassByPrefix("sidebar_");
                var a = $(".sidebar.visible");
                a.removeClass("visible"),
                    (window.removeAnimationTimeout = setTimeout(function () {
                        a.removeClass("animate active")
                            .find(".done")
                            .removeClass("done");
                    }, 500)),
                    (window.sidebarShown = 0),
        ...
        if (
            ...
            (window.isScroll ||
                (window.isSimplifiedMobile && window.isMobile)) &&
                ...
                if (c) {
                    ...
                    window.isScroll ||
                        ...
                        (j > window.windowHeight &&
                            (("up" === h && 0 === b.scrollTop()) ||
                            ("down" === h &&
                                b.scrollTop() + window.windowHeight >=
                                    Math.floor(j / k))
                                ? (window.allowSlide = 1)
                                : (window.allowSlide = 0),
                            window.panelsToHide &&
                ...
                $(".panel .compact").each(function (a, b) {
                    ...
                    $(window).on("load resize ready", function () {
                        var a = $(document).width(),
                            b =
                                parseInt(
                                    $(c).css("padding-left").replace("px", "")
                                ) +
                                parseInt(
                                    $(c).css("padding-right").replace("px", "")
                                );
        ...
        $("[data-slider-action]").click(function () {
            ...
            $(
                ".slider.clickable[data-slider-id], .controller[data-slider-id]"
            ).on("click", function (a) {
                "cancel" != $(a.target).data("slider-event") &&
                    $(window).resize();
            }),
            (window.dropdownShown = !1),
            ...
            $("#contact-form, [data-ajax-form]").each(function (a, b) {
                $(b).ajaxForm(function () {
                    var a = $(b),
                        ...
                        d = !!c.is("input"),
                        e = c.data("success-text")
                            ? c.data("success-text")
                            : "Done!",
                        f = c.data("success-class")
                            ? c.data("success-class")
                            : "green",
                        g = d ? c.val() : c.html(),
                        h = c.attr("class");
                    d ? c.val(e) : c.text(e),
            ...
            $(".soundTrigger").click(function () {
                var a = $(this).data("sound-id"),
                    ...
                    c = b.data("sound-action")
                        ? b.data("sound-action")
                        : "toggle",
                    d =
                        parseInt(b.data("sound-fade")) >= 0 ||
                        b.data("sound-fade")
